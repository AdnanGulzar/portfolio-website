...
const Experience = () => {
  return (
    <section className='mt-8 pb-8 max-w-[400px] pl-8 border-l-2 border-border '>
<ol className="relative border-s border-gray-200 dark:border-gray-700">                  
    <li className="mb-10 ms-6">            
        ...
        <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">Full Stack Developer<span className="bg-blue-100 text-blue-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ms-3">Latest</span></h3>
